    ...
    L.MarkerClusterGroup = L.FeatureGroup.extend({
        ...
        _defaultIconCreateFunction: function (t) {
            var e = t.getChildCount(),
                i = " marker-cluster-";
            return i += 50 > e ? "small" : 100 > e ? "medium" : "large", new L.DivIcon({
                html: "<div><span>" + e + "</span></div>",
                className: "marker-cluster" + i,
                iconSize: new L.Point(window.innerHeight/5, window.innerHeight/5)
            })
        },
        ...
        zoomToBounds: function () {
            ...
            this._group._map.setZoom(s+1, undefined, this._latlng)
        },
        getBounds: function () {
            var t = new L.LatLngBounds;
